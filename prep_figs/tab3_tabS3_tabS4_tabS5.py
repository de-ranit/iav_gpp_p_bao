...
if __name__ == "__main__":
    ...
    site_yr_opti_path_p = Path(
        ...
        "site_year_BRK15_FPAR_FLUXNET_EO_CO2_MLO_NOAA_nominal_cost_nnse_unc_correct_fW_10012024/"
        "opti_dicts/"
    )
    site_opti_path_p = Path(
        "../opti_results/P_model/"
        "all_year_BRK15_FPAR_FLUXNET_EO_CO2_MLO_NOAA_nominal_cost_nnse_unc_correct_fW_10012024/"
        "opti_dicts/"
    )
    site_iav_opti_path_p = Path(
        "../opti_results/P_model/"
        "all_year_BRK15_FPAR_FLUXNET_EO_CO2_MLO_NOAA_nominal_cost_nnse_unc_try_annual_cost_fn/"
        "opti_dicts/"
    )
    pft_opti_path_p = Path(
        "../opti_results/P_model/"
        "per_pft_BRK15_FPAR_FLUXNET_EO_CO2_MLO_NOAA_nominal_cost_nnse_unc_correct_fW_10012024/"
        "opti_dicts/"
    )
    global_opti_path_p = Path(
        "../opti_results/P_model/"
        "global_opti_BRK15_FPAR_FLUXNET_EO_CO2_MLO_NOAA_nominal_cost_nnse_unc_correct_fW_10012024/"
        "opti_dicts/"
    )
    ...
    site_yr_opti_path_lue_hr = Path(
        ...
        "site_year_BRK15_FPAR_FLUXNET_EO_CO2_MLO_NOAA_nominal_cost_lue_correct_fW_10012024/"
        "opti_dicts/"
    )
    site_opti_path_lue_hr = Path(
        "../opti_results/LUE_model/"
        "all_year_BRK15_FPAR_FLUXNET_EO_CO2_MLO_NOAA_nominal_cost_lue_correct_fW_10012024/"
        "opti_dicts/"
    )
    site_iav_opti_path_lue_hr = Path(
        "../opti_results/LUE_model/"
        "all_year_BRK15_FPAR_FLUXNET_EO_CO2_MLO_NOAA_nominal_cost_lue_try_annual_cost_fn/"
        "opti_dicts/"
    )
    pft_opti_path_lue_hr = Path(
        "../opti_results/LUE_model/"
        "per_pft_BRK15_FPAR_FLUXNET_EO_CO2_MLO_NOAA_nominal_cost_lue_correct_fW_10012024/"
        "opti_dicts/"
    )
    global_opti_path_lue_hr = Path(
        "../opti_results/LUE_model/"
        "global_opti_BRK15_FPAR_FLUXNET_EO_CO2_MLO_NOAA_nominal_cost_lue_correct_fW_10012024/"
        "opti_dicts/"
    )
    ...
    site_yr_opti_path_lue_dd = Path(
        ...
        "nominal_cost_lue_daily_correct_theta_unit_23032024/"
        "opti_dicts/"
    )
    ...
    site_iav_opti_path_lue_dd = Path(
        "../opti_results/LUE_model/"
        "all_year_BRK15_FPAR_FLUXNET_EO_CO2_MLO_NOAA_" 
        "nominal_cost_lue_daily_annual_cost_fn/"
        "opti_dicts/"
    )
